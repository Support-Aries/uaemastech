                    ...
                    <form class="contact-form" name="speaker-reg" id="speaker-reg" method="post" >
                        <div class="row gy-3">
                            ...
                            <div class="col-lg-6 mb-2 position-relative">
                                ...
                                <input type="email" class="form-control" id="exampleFormControlInput2"  name="email" required>
                            ...
                            <div class="col-lg-6 mb-2 position-relative">
                                ...
                                <input type="number" class="form-control" id="exampleFormControlInput3"  name="contact" required>
                            ...
                            <div class="col-lg-6 mb-2 position-relative">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput4"  name="company" required>
                            ...
                            <div class="col-lg-6 mb-2 position-relative">
                                ...
                                <input type="text" class="form-control" id="exampleFormControlInput5"  name="designation" required>
