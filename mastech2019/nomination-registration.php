        ...
        <div class="row justify-content-center align-items-center text-center text-content-div">
            ...
            <div class="info infoInnerpage">
                <a class="icon d-block mb-3">
                    <img src="assets/images/icon/mail1.svg" alt="Mail" style="color: #fff;"> testmailidEsol @gmail.com
                </a>
                <a class="location d-block mb-3">
                    <img src="assets/images/icon/map-pin2.svg" alt="Map">location : Dubai dubai
                </a>
            ...
            <div class="contact-wrap row py-4 px-3 contact align-items-start m-0">
                ...
                <div class="col-12 mt-4 mt-lg-0">
                    <form class="contact-form" name="nomination-reg" id="nomination-reg" method="POST"
                        ...
                        <!-- <div class="col-12 mb-3 input-div">
                            <div class="input-div g-recaptcha" data-sitekey="6Ldxe20UAAAAAD_17wcLirt0F7WmMb_Ixgoi3AYt">
                            </div>
                        </div> -->
                        ...
                        <div class="col-md-12 d-flex flex-column align-items-center mt-4">
                            <p id="submit">
                                <input type="submit" id="submit" name="submit" value="Submit Now"
                                    class="btn  custom-btn2 text-center" style="margin-top:35px;" />
                                <button type="button" class="btn  custom-btn2" value="Please Wait.."
...
<script type="text/javascript">
    var validate = $("#nomination-reg").validate({
        ...
        submitHandler: function (form) {
            ...
            // Disable submit and show waiting message
            $('#submit').hide();
            $('#waitmsg').show();
            form.submit();
        }
